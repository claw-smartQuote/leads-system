...
CONFIG = {
    'GROUP_URL': 'https://www.facebook.com/groups/945818406315161',
    'MAX_POSTS': 10,  # 最多處理的貼文數
    'DB_PATH': Path('/Users/claw/.openclaw/workspace/fb_group_leads.db'),
    'EXCEL_PATH': Path('/Users/claw/.openclaw/workspace/fb_社團潛客.xlsx'),
...
class FacebookGroupCrawler:
    ...
    def get_group_posts(self):
        """從社團頁面提取貼文連結"""
        print(f"\n🌐 訪問社團: {CONFIG['GROUP_URL']}")
        
        self.page.goto(CONFIG['GROUP_URL'], wait_until='networkidle', timeout=90000)
        time.sleep(5)
        ...
        for link in all_links:
            try:
                ...
                if '/groups/' in href and '/posts/' in href:
                    ...
                    if clean_url not in seen and clean_url not in post_urls:
...
def main():
    print("="*70)
    print("📘 Facebook 社團爬蟲 v7.0")
    print("="*70)
    print(f"目標社團: {CONFIG['GROUP_URL']}")
    ...
    try:
        ...
        # 獲取社團中的貼文連結
        post_urls = crawler.get_group_posts()
